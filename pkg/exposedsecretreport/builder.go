...
func (b *ReportBuilder) NamespacedReport() (v1alpha1.ExposedSecretReport, error) {
...
func (b *ReportBuilder) Get() (v1alpha1.ExposedSecretReport, v1alpha1.ClusterExposedSecretReport, error) {
	report, err := b.NamespacedReport()
	if err != nil {
		return v1alpha1.ExposedSecretReport{}, v1alpha1.ClusterExposedSecretReport{}, err
	}
	return report, b.clusterReport(), nil
}

func (b *ReportBuilder) clusterReport() v1alpha1.ClusterExposedSecretReport {
	...
	return v1alpha1.ClusterExposedSecretReport{
		ObjectMeta: metav1.ObjectMeta{
			Name:   artifactRef,
			Labels: reportLabels,
		},
